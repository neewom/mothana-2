...
1. **Corriger `lang="en"` en `"fr"` dans `index.html`** — cadré, très simple. [Trello](https://trello.com/c/Ie9HnnBT)
2. **Statuts non configurés : checkbox conditionnelle + rappel admin** — cadré (2026-09-12), simple (case masquée si `statuts_url` absent + bannière Dashboard, même pattern que les bannières existantes). [Trello](https://trello.com/c/jWEtNr7J)
3. **Campagne mail : guide Brevo pour Samakan** — cadré (2026-09-12), très simple (bloc d'aide repliable dans BrevoConfigModal, liens directs vers Brevo). [Trello](https://trello.com/c/7KcU5iXo)
...
5. **Vraie documentation utilisateur (guides / FAQ)** — pas encore cadré. [Trello](https://trello.com/c/5pwUxgqA)
6. **`agents.md` calqués sur `CLAUDE.md`** (switch Codex ↔ Claude Code) — pas encore cadré. [Trello](https://trello.com/c/0XmhK0iv)
7. **Mire de connexion personnalisée par organisation** (admin + bénévole) — cadré. [Trello](https://trello.com/c/gkOuH3uh)
8. **DecouvrirPage : rafraîchir les 15 captures (nouvelle UI) + ajouter Dons réguliers et Modèles de reçus personnalisables** — cadré, non urgent (page prospects). [Trello](https://trello.com/c/6e0mb8n3)
9. **Campagne courrier & mail : aperçu nominatif des destinataires** — cadré (2026-09-12), périmètre élargi du courrier seul aux deux canaux, duplication assumée entre les deux pages (règles métier différentes, opt-out mail notamment). [Trello](https://trello.com/c/sxdsAbDq)
10. **Listes adhérents : gestion des listes** (renommer/vider/supprimer, avec alerte sur le nombre d'adhérents impactés) — cadré (2026-09-12), modale dédiée depuis AdherentsPage. [Trello](https://trello.com/c/rjDwivqC)
11. **Page Adhérents : retirer en masse une liste sur la sélection courante** (symétrique au bouton "Ajouter à une liste" existant) — cadré (2026-09-12). [Trello](https://trello.com/c/DIVUULY2)
12. **Page Adhérents : configurer les colonnes affichées dans le tableau** — cadré (2026-09-12), préférence personnelle en localStorage, colonnes obligatoires Nom/Prénom seulement. [Trello](https://trello.com/c/b5jKyWtv)
13. **OCR scan de carte adhérent** — pas encore cadré. [Trello](https://trello.com/c/zVBOjAWk)
14. **Priorité 5 — Export comptable enrichi** — recadré, roadmap lointaine. [Trello](https://trello.com/c/W3GCYUOt)
15. **Priorité 5 — Brique événements/coupons + portefeuille virtuel** (Pagode Coupon) — clarifié, prérequis (inspection projet Supabase "pagode-coupon") avant cadrage technique. [Trello](https://trello.com/c/C9A5B9jr)
16. **Priorité 5 — Gestion abonnements/plans** (facturation Samakan) — désormais rattachée à la liste Trello "Business plan — Commercialisation" (checklist commercialisation plus large créée le 2026-09-11 : pricing, juridique, marketing, support), roadmap lointaine. [Trello](https://trello.com/c/cfKF8BNw)
17. **Revoir tous les CTAs pour appliquer le design adapté** — pas encore cadré. [Trello](https://trello.com/c/mWKDv05R)
