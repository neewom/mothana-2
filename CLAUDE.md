...
7. **DecouvrirPage : rafraîchir les 15 captures (nouvelle UI) + ajouter Dons réguliers et Modèles de reçus personnalisables** — cadré, non urgent (page prospects). [Trello](https://trello.com/c/6e0mb8n3)
8. **Campagne courrier & mail : aperçu nominatif des destinataires** — cadré (2026-09-12), périmètre élargi du courrier seul aux deux canaux, duplication assumée entre les deux pages (règles métier différentes, opt-out mail notamment). [Trello](https://trello.com/c/sxdsAbDq)
...
10. **OCR scan de carte adhérent** — pas encore cadré. [Trello](https://trello.com/c/zVBOjAWk)
...
14. **Campagne mail : guide pour récupérer les infos Brevo à fournir à Samakan** — pas encore cadré, nouveau. [Trello](https://trello.com/c/7KcU5iXo)
15. **Page Adhérents : configurer les champs affichés dans le tableau** — pas encore cadré. [Trello](https://trello.com/c/b5jKyWtv)
16. **Page Adhérents : retirer en masse des adhérents d'une liste** — pas encore cadré. [Trello](https://trello.com/c/DIVUULY2)
...
20. **Dette technique : factoriser CampagneCourrierPage / CampagneMailingPage** — pas encore cadré, repéré le 2026-09-12 pendant le cadrage de l'item 8, traitement reporté volontairement. [Trello](https://trello.com/c/RBsb8fbs)
