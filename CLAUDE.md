...
10. **Sélection d'un adhérent à la saisie d'un don + doublonnement** — prio basse (dit explicitement par l'utilisateur), hors scope V1 du module Adhérents. Revérifié 2026-08-20 (toujours pas de lien en base adherents↔profils_participant) : cadrage volontairement resté léger vu la priorité, un cadrage détaillé complet restera nécessaire avant tout dev (mécanisme de dédoublonnage non trivial). [Trello](https://trello.com/c/RtRY8ltX)
11. **OCR scan de carte adhérent** — pas encore cadré, discussion préliminaire seulement, intégration API OCR externe, besoin niche déjà partiellement couvert par la recherche nom/prénom (livrée). [Trello](https://trello.com/c/zVBOjAWk)
12. **Priorité 5 — Export comptable enrichi** (recadré 2026-08-20, ex-"Export FEC") — un vrai FEC (partie double, plan de comptes) serait un chantier disproportionné vu l'absence totale de modélisation comptable dans Mothana ; objectif ramené à enrichir le CSV dons existant. Roadmap lointaine, besoin concret toujours non confirmé. [Trello](https://trello.com/c/W3GCYUOt)
13. **Priorité 5 — Brique événements/coupons + portefeuille virtuel** (Pagode Coupon) — clarifié 2026-08-20 : précommande/prépaiement en ligne pour les événements de la pagode (dimensionner les achats, avance de trésorerie), deux mécanismes retenus (coupon = droit à un article précis, ET portefeuille virtuel = solde rechargeable). Un projet séparé existe déjà (Supabase "pagode-coupon", en pause), pas encore inspecté — prérequis avant cadrage technique. [Trello](https://trello.com/c/C9A5B9jr)
14. **Priorité 5 — Gestion abonnements/plans** (facturation Samakan) — clarifié 2026-08-20 : facturation SaaS de Samakan lui-même (les organisations clientes paient un abonnement), pas une fonctionnalité pour les donateurs des associations. Aucun modèle économique décidé à ce jour, roadmap lointaine. [Trello](https://trello.com/c/cfKF8BNw)
