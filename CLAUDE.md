...
1. **Aspect légal du mailing** (RGPD, opt-out, page de désinscription) — remonté en tête : la campagne de mailing Brevo est déjà en prod et envoie à de vrais adhérents sans mécanisme d'opt-out connu, risque de conformité réel malgré une complexité encore inconnue (pas cadré). [Trello](https://trello.com/c/e3aJfN3l)
