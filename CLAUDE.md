...
- **Afficher le numéro d'adhérent dans la vérification bénévole** (terminé 2026-08-22, PR #79 dev) : `search_adherents_verification` renvoie désormais `id_externe` (numéro d'adhérent, pas une donnée sensible), affiché "N° adhérent : …" dans `BenevoleVerificationAdherent.tsx`, masqué si vide. Vérifié de bout en bout sur la recette via le vrai flux PIN bénévole.
