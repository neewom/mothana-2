...
9. **Page Adhérents : retirer en masse une liste sur la sélection courante** (symétrique au bouton "Ajouter à une liste" existant) — cadré (2026-09-12). [Trello](https://trello.com/c/DIVUULY2)
10. **Page Adhérents : configurer les colonnes affichées dans le tableau** — cadré (2026-09-12), préférence personnelle en localStorage, colonnes obligatoires Nom/Prénom seulement. [Trello](https://trello.com/c/b5jKyWtv)
...
15. **Revoir tous les CTAs pour appliquer le design adapté** — pas encore cadré. [Trello](https://trello.com/c/mWKDv05R)
16. **Appliquer la méthodologie des tableaux à tous les tableaux** — pas encore cadré. [Trello](https://trello.com/c/wZaVqyIF)
17. **Renommer Participants en Donateurs** — pas encore cadré. [Trello](https://trello.com/c/XpeENrtz)
18. **Dette technique : factoriser CampagneCourrierPage / CampagneMailingPage** — pas encore cadré, repéré le 2026-09-12 pendant le cadrage de l'aperçu nominatif destinataires, traitement reporté volontairement. [Trello](https://trello.com/c/RBsb8fbs)
19. **Bug mineur : tutoiement isolé sur DonsReguliersPage** — pas encore cadré, repéré le 2026-09-12 en capturant DecouvrirPage, fix trivial (ta → votre). [Trello](https://trello.com/c/yR7ZGoUc)
