...
- **Identifier l'espace bénévole + l'organisation dans le header** (terminé 2026-08-22, PR #78 dev) : header `/benevole` sur 2 lignes, ligne 1 inchangée ("Samakan" + Quitter), ligne 2 "Espace bénévole — *Organisation*" (même pattern de fetch que `AdminLayout.tsx`). Vérifié de bout en bout sur la recette via le vrai flux PIN bénévole.
