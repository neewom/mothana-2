...
1. **Bug — reset password (prod) : le lien reçu par email redirige vers `mothana.vercel.app` au lieu de `samakan.fr`** — pas encore cadré, nouveau, prod/sensible. [Trello](https://trello.com/c/wyU4Aw7Y)
2. **Corriger `lang="en"` en `"fr"` dans `index.html`** — cadré, très simple. [Trello](https://trello.com/c/Ie9HnnBT)
...
12. **Campagne courrier : voir les adhérents inclus dans la liste sélectionnée** — pas encore cadré, nouveau. [Trello](https://trello.com/c/sxdsAbDq)
13. **Listes adhérents : gestion des listes** — pas encore cadré, nouveau. [Trello](https://trello.com/c/rjDwivqC)
...
20. **Il manque le lien vers les statuts sur la page de demande d'adhésion** — pas encore cadré. [Trello](https://trello.com/c/jWEtNr7J)
