...
19. **Vérifier et améliorer la gestion verticale de l'espace en mobile** — détectée le 2026-08-22, pas encore cadrée. Contenu masqué par les barres de navigation sur mobile, pas toujours pratique/agréable selon l'utilisateur. À creuser au cadrage : pages concernées, safe-area iOS vs. scroll interne manquant vs. vrai déficit de hauteur. [Trello](https://trello.com/c/FWQDasSX)
