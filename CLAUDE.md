...
Ordre reclassé le 2026-08-20, complété le 2026-08-21 (jugement agent, mix importance/complexité — pas un simple reflet de l'ordre d'ajout) :

Passe complète de revérification/cadrage effectuée le 2026-08-20 (voir détail des décisions dans chaque carte Trello) :

1. **Vraie documentation utilisateur (guides / FAQ)** — détectée le 2026-08-21 en scindant la page de tour produit `/decouvrir` (terminée, voir "✅ Terminé"), pas encore cadrée. Piste évoquée par l'utilisateur : format FAQ plutôt qu'un mode d'emploi linéaire, avec recherche par mot-clé. [Trello](https://trello.com/c/5pwUxgqA)
2. **Créer et maintenir des `agents.md` calqués sur les `CLAUDE.md`** (pour pouvoir switcher entre Codex et Claude Code) — carte détectée le 2026-08-21, pas encore cadrée. [Trello](https://trello.com/c/0XmhK0iv)
3. **Corriger le branding Mothana→Samakan dans les emails** (création admin + reset password) — cadré le 2026-08-20 : oubli du renommage du 2026-08-19, `create-admin`/`request-password-reset` envoient encore des emails "Mothana" à de vrais admins. Périmètre réduit à la correction du texte en dur, pas de nouvelle UI. Faible complexité, corrige un bug de branding en prod. [Trello](https://trello.com/c/Qf8mdFTz)
