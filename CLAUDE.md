...
7. **Campagne courrier & mail : aperçu nominatif des destinataires** — cadré (2026-09-12), périmètre élargi du courrier seul aux deux canaux, duplication assumée entre les deux pages (règles métier différentes, opt-out mail notamment). [Trello](https://trello.com/c/sxdsAbDq)
8. **Listes adhérents : gestion des listes** (renommer/vider/supprimer, avec alerte sur le nombre d'adhérents impactés) — cadré (2026-09-12), modale dédiée depuis AdherentsPage. [Trello](https://trello.com/c/rjDwivqC)
...
13. **Campagne mail : guide pour récupérer les infos Brevo à fournir à Samakan** — pas encore cadré, nouveau. [Trello](https://trello.com/c/7KcU5iXo)
14. **Page Adhérents : configurer les champs affichés dans le tableau** — pas encore cadré. [Trello](https://trello.com/c/b5jKyWtv)
15. **Page Adhérents : retirer en masse des adhérents d'une liste** — pas encore cadré. [Trello](https://trello.com/c/DIVUULY2)
...
19. **Il manque le lien vers les statuts sur la page de demande d'adhésion** — pas encore cadré. [Trello](https://trello.com/c/jWEtNr7J)
