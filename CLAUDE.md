...
1. **Page de tour produit `/decouvrir`** (pour clients/prospects) — cadrée le 2026-08-19/20, développée le 2026-08-21 (PR #71, en attente de relecture). Renommée depuis `/documentation` : à la relecture, le contenu (galerie de captures + accroches courtes) correspond à un tour produit marketing, pas à une vraie doc instructionnelle — d'où l'item 2 ci-dessous, scindé de ce sujet. [Trello](https://trello.com/c/ngo5wJSS)
2. **Vraie documentation utilisateur (guides / FAQ)** — détectée le 2026-08-21 en scindant le sujet précédent, pas encore cadrée. Piste évoquée par l'utilisateur : format FAQ plutôt qu'un mode d'emploi linéaire. [Trello](https://trello.com/c/5pwUxgqA)
