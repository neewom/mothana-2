// Liste des pays (noms français), utilisée pour le select "Pays" des formulaires adhérent.
export const COUNTRIES: string[] = [
  ...
  'Chili', 'Chine', 'Chypre', 'Colombie', 'Comores', 'Congo', 'Congo (RDC)', 'Corée du Nord',
  ...
  'Eswatini', 'États-Unis', 'Éthiopie', 'Fidji', 'Finlande', 'Gabon', 'Gambie', 'Géorgie',
