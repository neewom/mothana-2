...
function IdCardIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 9h3.75M15 12h3.75M15 15h3.75M4.5 19.5h15a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5h-15A1.5 1.5 0 003 6v12a1.5 1.5 0 001.5 1.5zm6.75-10.5a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0zm-4.5 6a2.25 2.25 0 00-2.25 2.25v.75h6.75v-.75A2.25 2.25 0 008.25 15z" />
    </svg>
  )
}
...
function NavGroupItem({ group, onClose }: { group: NavGroup; onClose?: () => void }) {
  ...
  // Pas d'état "ouvert" propre : dérivé de la route active, avec une bascule
